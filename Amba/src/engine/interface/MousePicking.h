...
namespace Amba {
	...
	private:
		...
		glm::vec4 ClipSpace(glm::vec3 mousePosition);
		glm::vec4 EyeSpace(glm::vec4 mousePosition, Camera& camera);
		glm::vec3 WorldSpace(glm::vec4 mousePosition, Camera& camera);
